...
public:
	...
	static bool AbilityHasSlot(const FGameplayAbilitySpec& Ability, const FGameplayTag& Slot);
	static bool AbilityHasAnySlot(const FGameplayAbilitySpec& Ability);
	...
	bool GetDescriptionByAbilityTag(const FGameplayTag& AbilityTag, FString& OutDescription, FString& OutNextLevelDescription, const FAuraAbilityInfo& AbilityInfo);
